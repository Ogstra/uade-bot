...
var sharedCSS = `:root{--bg:#f4f7fb;--panel:#fff;--accent:#2563eb;--text:#101828;--muted:#475467;--border:#d0d5dd}*{box-sizing:border-box}html{background:var(--bg);color:var(--text);font:16px/1.5 system-ui,sans-serif}body{margin:0}button,input{font:inherit;min-height:44px}.page{max-width:1280px;margin:auto;padding:32px 16px 64px}.panel,.health-card,.job-panel,.account{background:var(--panel);border:1px solid var(--border);border-radius:12px;padding:16px}.grid,.jobs,.history{display:grid;gap:16px}.health-grid{display:grid;gap:16px;grid-template-columns:repeat(auto-fit,minmax(180px,1fr))}.health-card{display:flex;flex-direction:column;gap:4px}.metadata{color:var(--muted);overflow-wrap:anywhere}.badge{border-radius:999px;padding:4px 8px}.badge--healthy{background:#ecfdf3;color:#067647}.badge--warning{background:#fffaeb;color:#b54708}.badge--failure{background:#fef3f2;color:#b42318}.badge--neutral{background:#f2f4f7;color:#475467}.account{margin:16px 0}.account>summary{display:flex;align-items:center;flex-wrap:wrap;gap:8px}.job-panel{margin:12px 0}table{border-collapse:collapse;width:100%}th,td{border-bottom:1px solid var(--border);padding:8px;text-align:left}.login-page{display:flex;align-items:center;justify-content:center;min-height:100vh;padding:16px}.login-panel{max-width:400px;width:100%}.field{display:grid;gap:8px;margin:12px 0}input{padding:8px}.primary{background:var(--accent);border:0;border-radius:8px;color:white;padding:8px 16px}.page-header{display:flex;flex-wrap:wrap;justify-content:space-between;gap:16px}.header-actions{display:flex;gap:16px;align-items:center}.avatar{vertical-align:middle;border-radius:50%;margin-right:8px}.job-actions{display:flex;gap:8px;margin:8px 0}.job-actions button{border:1px solid var(--border);border-radius:8px;background:var(--panel);padding:4px 12px;cursor:pointer}.job-actions .danger{background:#fef3f2;color:#b42318;border-color:#fda29b}`
